...
class Admin_model extends CI_Model
{
    ...
    public function countTotalSusuDiagram($table)
    {
        $query = $this->db->select_sum('total_produksi_susu')->select_sum('bocor_atas')->select_sum('bocor_bawah')->select_sum('bocor_tutup')->select_sum('bocor_atas')->select_sum('total_reject_susu')->get($table);
        if ($query->num_rows() > 0) {
    ...
    public function getSemuaTotalSusuPerBulan()
    {
        $query = $this->db->get("v_total_susu");
    ...
    public function getTotalSusuPerBulan($table)
    {
        $query = $this->db->select('total_produksi_susu')->select('total_reject_susu')->get($table);
    ...
    public function getSemuaPersenanSusu()
    {
        $query = $this->db->query("SELECT sum(total_reject_susu)/sum(total_produksi_susu)*100 as persenan_reject, 100-sum(total_reject_susu)/sum(total_produksi_susu)*100 as persenan_produksi FROM v_total_susu");
    ...
    public function getPersenanSusu($table)
    {
        $query = $this->db->query("SELECT (sum(total_reject_susu)/sum(total_produksi_susu)*100) as persenan_reject, (100 - (sum(total_reject_susu)/sum(total_produksi_susu)*100)) as persenan_produksi FROM $table;");
    ...
    public function getBocorSusu($table)
    {
        $query = $this->db->select('bocor_atas')->select('bocor_bawah')->select('bocor_tutup')->get($table);
    ...
    public function getLineChartSusu($table)
    {
    ...
    public function getNilaiSigma($table)
    {
        $query = $this->db->select_sum('total_produksi_susu')->select_sum('bocor_atas')->select_sum('bocor_bawah')->select_sum('bocor_tutup')->select_sum('bocor_atas')->select_sum('total_reject_susu')->get($table)->row_array();
