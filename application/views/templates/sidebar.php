 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin') ?>">
         ...
         <div class="sidebar-brand-text mx-3">Deviation Check App</div>
     </a>
         ...
         <?php if ($this->uri->segment(1) == 'reject') : ?>
             ...
             <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                 <div class="bg-white py-2 collapse-inner rounded">
                     ...
                     <a class="collapse-item" href="<?= base_url('reject/reject_nonfat') ?>">Plain Not Fat</a>
                 </div>
             </div>
             </li>
             ...
             <?php if ($this->uri->segment(1) == 'datamaster') : ?>
                 ...
                 <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                         ...
                         <a class="collapse-item" href="<?= base_url('datamaster/susu_nonfat') ?>">Plain Not Fat</a>
